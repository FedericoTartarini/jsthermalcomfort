 ...
 */
export function evaporation(err_cr, err_sk, t_skin, tdb, rh, ret, height = JOS3Defaults.height, weight = JOS3Defaults.weight, bsa_equation = JOS3Defaults.bsa_equation, age = JOS3Defaults.age) {
