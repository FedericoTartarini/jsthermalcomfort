...
exports.e_pmv_array = exports.e_pmv = void 0;
 ...
 */
function e_pmv(tdb, tr, vr, rh, met, clo, e_coefficient, wme = 0, kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
    };
    kwargs = Object.assign(default_kwargs, kwargs);
    let _pmv = (0, pmv_js_1.pmv)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    met = _pmv > 0 ? met * (1 + _pmv * -0.067) : met;
    _pmv = (0, pmv_js_1.pmv)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    return (0, utilities_js_1.round)(_pmv * e_coefficient, 2);
}
exports.e_pmv = e_pmv;
/**
 * Returns Adjusted Predicted Mean Votes with Expectancy Factor (ePMV). This index was developed by
 ...
 */
function e_pmv_array(tdb, tr, vr, rh, met, clo, e_coefficient, wme, kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
    };
    kwargs = Object.assign(default_kwargs, kwargs);
    let _pmv = (0, pmv_js_1.pmv_array)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    met = _pmv.map((value, i) => {
        return value > 0 ? met[i] * (1 + value * -0.067) : met[i];
    });
    _pmv = (0, pmv_js_1.pmv_array)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    return _pmv.map((value, i) => {
        return (0, utilities_js_1.round)(value * e_coefficient[i], 2);
    });
}
exports.e_pmv_array = e_pmv_array;
