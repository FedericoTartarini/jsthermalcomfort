import { round, units_converter, units_converter_array, valid_range, } from "../utilities/utilities.js";
const g = [
    -2836.5744,
    -6028.076559,
    19.54263612,
 ...
 */
export function utci(tdb, tr, v, rh, units = "SI", return_stress_category = true, limit_inputs = true, round_output = true) {
    let kwargs;
    let ret;
 ...
 * // will print {
   //     utci: [25.2, 24.6],
    ...
    //  }
 */
export function utci_array(tdb, tr, v, rh, units = "SI", return_stress_category = true, limit_inputs = true, round_output = true) {
    let kwargs;
    let ret;
    if (units.toLowerCase() == "ip") {
        kwargs = {
