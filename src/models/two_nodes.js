...
function calculateTwoNodesOptimized(
    ...
    while (nSimulation < lengthTimeSimulation) {
        ...
        eMax = (Math.exp(18.6686 - 4030.183 / (tSkin + 235.0)) - vaporPressure) / (rEa + rEcl);
    ...
    const rCloS =
        1.52 / ((met - wme / metFactor) + 0.6944) - 0.1835; // thermal resistance of clothing, °C M^2 /W
    ...
    const iClS =
        iMS *
        (hCS / hTS) *
        ((1 - fClS) / (hCS / hTS - fClS * iMS)); // clothing vapor permeation efficiency
