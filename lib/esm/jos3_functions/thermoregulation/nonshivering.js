 ...
 */
export function nonshivering(err_sk, height = JOS3Defaults.height, weight = JOS3Defaults.weight, bsa_equation = JOS3Defaults.bsa_equation, age = JOS3Defaults.age, cold_acclimation = false, batpositive = true) {
