...
const bsa_rate_js_1 = require("../jos3_functions/bsa_rate.js");
const local_bsa_js_1 = require("../jos3_functions/local_bsa.js");
const bfb_rate_js_1 = require("../jos3_functions/bfb_rate.js");
const conductance_js_1 = require("../jos3_functions/conductance.js");
const capacity_js_1 = require("../jos3_functions/capacity.js");
const math = __importStar(require("mathjs"));
const matrix_js_1 = require("../jos3_functions/matrix.js");
const shivering_js_1 = require("../jos3_functions/thermoregulation/shivering.js");
const basal_met_js_1 = require("../jos3_functions/thermoregulation/basal_met.js");
const pmv_js_1 = require("./pmv.js");
const fixed_hc_js_1 = require("../jos3_functions/thermoregulation/fixed_hc.js");
const conv_coef_js_1 = require("../jos3_functions/thermoregulation/conv_coef.js");
const fixed_hr_js_1 = require("../jos3_functions/thermoregulation/fixed_hr.js");
const rad_coef_js_1 = require("../jos3_functions/thermoregulation/rad_coef.js");
const operative_temp_js_1 = require("../jos3_functions/thermoregulation/operative_temp.js");
const dry_r_js_1 = require("../jos3_functions/thermoregulation/dry_r.js");
const wet_r_js_1 = require("../jos3_functions/thermoregulation/wet_r.js");
const evaporation_js_1 = require("../jos3_functions/thermoregulation/evaporation.js");
const skin_blood_flow_js_1 = require("../jos3_functions/thermoregulation/skin_blood_flow.js");
const ava_blood_flow_js_1 = require("../jos3_functions/thermoregulation/ava_blood_flow.js");
const nonshivering_js_1 = require("../jos3_functions/thermoregulation/nonshivering.js");
const local_mbase_js_1 = require("../jos3_functions/thermoregulation/local_mbase.js");
const sum_m_js_1 = require("../jos3_functions/thermoregulation/sum_m.js");
const local_q_work_js_1 = require("../jos3_functions/thermoregulation/local_q_work.js");
const cr_ms_fat_blood_flow_js_1 = require("../jos3_functions/thermoregulation/cr_ms_fat_blood_flow.js");
const resp_heat_loss_js_1 = require("../jos3_functions/thermoregulation/resp_heat_loss.js");
const sum_bf_js_1 = require("../jos3_functions/thermoregulation/sum_bf.js");
const object_js_1 = __importDefault(require("lodash/object.js"));
/**
...
function _to17array(inp) {
    ...
    if (typeof inp === "object") {
        return math.matrix(matrix_js_1.BODY_NAMES.map((name) => inp[name]));
    }
...
class JOS3 {
     ...
     */
    constructor(height = JOS3Defaults_js_1.default.height, weight = JOS3Defaults_js_1.default.weight, fat = JOS3Defaults_js_1.default.body_fat, age = JOS3Defaults_js_1.default.age, sex = JOS3Defaults_js_1.default.sex, ci = JOS3Defaults_js_1.default.cardiac_index, bmr_equation = JOS3Defaults_js_1.default.bmr_equation, bsa_equation = JOS3Defaults_js_1.default.bsa_equation, ex_output = []) {
        ...
        this._bsa_rate = (0, bsa_rate_js_1.bsa_rate)(height, weight, bsa_equation);
        // Calculate local body surface area
        this._bsa = (0, local_bsa_js_1.local_bsa)(height, weight, bsa_equation);
        // Calculate basal blood flow (BFB) rate [-]
        this._bfb_rate = (0, bfb_rate_js_1.bfb_rate)(height, weight, bsa_equation, age, ci);
        // Calculate thermal conductance (CDT) [W/K]
        this._cdt = (0, conductance_js_1.conductance)(height, weight, bsa_equation, fat);
        // Calculate thermal capacity [J/K]
        this._cap = (0, capacity_js_1.capacity)(height, weight, bsa_equation, age, ci);
        // Set initial core and skin temperature set points [°C]
        this.setpt_cr = math.multiply(math.ones(17), JOS3Defaults_js_1.default.core_temperature);
        this.setpt_sk = math.multiply(math.ones(17), JOS3Defaults_js_1.default.skin_temperature);
        // Initialize body temperature [°C]
        this._bodytemp = math.multiply(math.ones(matrix_js_1.NUM_NODES), JOS3Defaults_js_1.default.other_body_temperature);
        // Initialize environmental conditions and other factors
        // (Default values of input conditions)
        this._ta = math.multiply(math.ones(17), JOS3Defaults_js_1.default.dry_bulb_air_temperature);
        this._tr = math.multiply(math.ones(17), JOS3Defaults_js_1.default.mean_radiant_temperature);
        this._rh = math.multiply(math.ones(17), JOS3Defaults_js_1.default.relative_humidity);
        this._va = math.multiply(math.ones(17), JOS3Defaults_js_1.default.air_speed);
        this._clo = math.multiply(math.ones(17), JOS3Defaults_js_1.default.clothing_insulation);
        this._iclo = math.multiply(math.ones(17), JOS3Defaults_js_1.default.clothing_vapor_permeation_efficiency);
        this._par = JOS3Defaults_js_1.default.physical_activity_ratio;
        this._posture = JOS3Defaults_js_1.default.posture;
        this._hc = null; // Convective heat transfer coefficient
        this._hr = null; // Radiative heat transfer coefficient
        this.ex_q = math.zeros(matrix_js_1.NUM_NODES); // External heat gain
        ...
        (0, shivering_js_1.set_pre_shiv)(0);
        ...
        const dictout = this._reset_setpt(JOS3Defaults_js_1.default.physical_activity_ratio);
     ...
     * @returns {number}
     */
    _calculate_operative_temp_when_pmv_is_zero(va = JOS3Defaults_js_1.default.air_speed, rh = JOS3Defaults_js_1.default.relative_humidity, met = JOS3Defaults_js_1.default.metabolic_rate, clo = JOS3Defaults_js_1.default.clothing_insulation) {
        let to = 28; // initial operative temperature
        // Iterate until the PMV (Predicted Mean Vote) value is less than 0.001
        let vpmv;
        for (let i = 0; i < 100; i++) {
            vpmv = (0, pmv_js_1.pmv)(to, to, va, rh, met, clo);
     ...
     */
    _reset_setpt(par = JOS3Defaults_js_1.default.physical_activity_ratio) {
        ...
        this.rh = JOS3Defaults_js_1.default.relative_humidity;
        this.v = JOS3Defaults_js_1.default.air_speed;
        this.clo = JOS3Defaults_js_1.default.clothing_insulation;
        this.par = par;
        // Steady-calculatio
    ...
    _run(dtime = 60, passive = false, output = true) {
        ...
        let hc = (0, fixed_hc_js_1.fixed_hc)((0, conv_coef_js_1.conv_coef)(this._posture, this._va, this._ta, tsk), this._va);
        let hr = (0, fixed_hr_js_1.fixed_hr)((0, rad_coef_js_1.rad_coef)(this._posture));
        ...
        // Operative temp. [°C]
        let to = (0, operative_temp_js_1.operative_temp)(this._ta, this._tr, hc, hr);
        // Clothing heat resistance [m2.K/W]
        let r_t = (0, dry_r_js_1.dry_r)(hc, hr, this._clo);
        // Clothing evaporative resistance [m2.kPa/W]
        let r_et = (0, wet_r_js_1.wet_r)(hc, this._clo, this._iclo);
        // ------------------------------------------------------------------
        // Thermoregulation
        // 1) Sweating
        ...
        let { wet, e_sk, e_max, e_sweat } = (0, evaporation_js_1.evaporation)(err_cr, err_sk, tsk, this._ta, this._rh, r_et, this._height, this._weight, this._bsa_equation, this._age);
        // VASOCONSTRICTION, VASODILATION
        // Calculate skin blood flow and basal skin blood flow [L/h]
        let bf_skin = (0, skin_blood_flow_js_1.skin_blood_flow)(err_cr, err_sk, this._height, this._weight, this._bsa_equation, this._age, this._ci);
        // Calculate hands and feet's AVA blood flow [L/h]
        let { bf_ava_hand, bf_ava_foot } = (0, ava_blood_flow_js_1.ava_blood_flow)(err_cr, err_sk, this._height, this._weight, this._bsa_equation, this._age, this._ci);
        ...
        let q_shiv = (0, shivering_js_1.shivering)(err_cr, err_sk, tcr, tsk, this._height, this._weight, this._bsa_equation, this._age, this._sex, dtime, this.options);
        // Calculate non-shivering thermogenesis (NST) [W]
        let q_nst = this.options["nonshivering_thermogenesis"]
            ? (0, nonshivering_js_1.nonshivering)(err_sk, this._height, this._weight, this._bsa_equation, this._age, this.options["cold_acclimated"], this.options["bat_positive"])
            : math.zeros(17);
        // ------------------------------------------------------------------
        // Thermogenesis
        // ------------------------------------------------------------------
        // Calculate local basal metabolic rate (BMR) [W]
        let q_bmr_local = (0, local_mbase_js_1.local_mbase)(this._height, this._weight, this._age, this._sex, this._bmr_equation);
        ...
        let q_work = (0, local_q_work_js_1.local_q_work)(q_bmr_total, this._par);
        // Calculate the sum of thermogenesis in core, muscle, fat, skin [W]
        let { q_thermogenesis_core, q_thermogenesis_muscle, q_thermogenesis_fat, q_thermogenesis_skin, } = (0, sum_m_js_1.sum_m)(q_bmr_local.map((c) => c.clone()), q_work, q_shiv, q_nst);
        ...
        let { bf_core, bf_muscle, bf_fat } = (0, cr_ms_fat_blood_flow_js_1.cr_ms_fat_blood_flow)(q_work, q_shiv, this._height, this._weight, this._bsa_equation, this._age, this._ci);
        // Calculate heat loss by respiratory
        let p_a = math.dotDivide(math.dotMultiply(this._ta.map(evaporation_js_1.antoine), this._rh), 100);
        let { res_sh, res_lh } = (0, resp_heat_loss_js_1.resp_heat_loss)(this._ta.get([0]), p_a.get([0]), q_thermogenesis_total);
        ...
        let co = (0, sum_bf_js_1.sum_bf)(bf_core, bf_muscle, bf_fat, bf_skin, bf_ava_hand, bf_ava_foot);
        ...
        let { bf_art, bf_vein } = (0, matrix_js_1.vessel_blood_flow)(bf_core, bf_muscle, bf_fat, bf_skin, bf_ava_hand, bf_ava_foot);
        let bf_local = (0, matrix_js_1.local_arr)(bf_core, bf_muscle, bf_fat, bf_skin, bf_ava_hand, bf_ava_foot);
        let bf_whole = (0, matrix_js_1.whole_body)(bf_art, bf_vein, bf_ava_hand, bf_ava_foot);
        let arr_bf = math.zeros(matrix_js_1.NUM_NODES, matrix_js_1.NUM_NODES);
        ...
        arr_bf = math.dotDivide(arr_bf, math.reshape(this._cap, [matrix_js_1.NUM_NODES, 1])); // Change unit [W/K] to [/sec]
        ...
        arr_cdt = math.dotDivide(arr_cdt, math.reshape(this._cap, [matrix_js_1.NUM_NODES, 1])); // Change unit [W/K] to [/sec]
        arr_cdt = math.dotMultiply(arr_cdt, dtime); // Change unit [/sec] to [-]
        // Matrix B = Matrix for heat transfer between skin and environment
        let arr_b = math.zeros(matrix_js_1.NUM_NODES);
        arr_b = math.subset(arr_b, math.index(matrix_js_1.INDEX["skin"]), math.add(math.subset(arr_b, math.index(matrix_js_1.INDEX["skin"])), math.dotMultiply(math.dotDivide(1, r_t), this._bsa)));
        ...
        arr_a_dia = math.add(arr_a_dia, math.identity(matrix_js_1.NUM_NODES));
        ...
        // Matrix Q [W] / [J/K] * [sec] = [-]
        // Thermogensis
        let arr_q = math.zeros(matrix_js_1.NUM_NODES);
        arr_q = math.subset(arr_q, math.index(matrix_js_1.INDEX["core"]), math.add(math.subset(arr_q, math.index(matrix_js_1.INDEX["core"])), q_thermogenesis_core));
        arr_q = math.subset(arr_q, math.index(matrix_js_1.INDEX["muscle"]), math.add(math.subset(arr_q, math.index(matrix_js_1.INDEX["muscle"])), math.subset(q_thermogenesis_muscle, math.index(matrix_js_1.VINDEX["muscle"]))));
        arr_q = math.subset(arr_q, math.index(matrix_js_1.INDEX["fat"]), math.add(math.subset(arr_q, math.index(matrix_js_1.INDEX["fat"])), math.subset(q_thermogenesis_fat, math.index(matrix_js_1.VINDEX["fat"]))));
        arr_q = math.subset(arr_q, math.index(matrix_js_1.INDEX["skin"]), math.add(math.subset(arr_q, math.index(matrix_js_1.INDEX["skin"])), q_thermogenesis_skin));
        // Respiratory [W]
        arr_q.set([matrix_js_1.INDEX["core"][2]], arr_q.get([matrix_js_1.INDEX["core"][2]]) - (res_sh + res_lh)); // chest core
        // Sweating [W]
        arr_q = math.subset(arr_q, math.index(matrix_js_1.INDEX["skin"]), math.subtract(math.subset(arr_q, math.index(matrix_js_1.INDEX["skin"])), e_sk));
        // Extra heat gain [W]
        ...
        // Boundary batrix [°C]
        let arr_to = math.zeros(matrix_js_1.NUM_NODES);
        arr_to = math.subset(arr_to, math.index(matrix_js_1.INDEX["skin"]), math.add(math.subset(arr_to, math.index(matrix_js_1.INDEX["skin"])), to));
        ...
        if (output) {
            ...
            dict_out["w_mean"] =
                math.sum(math.dotMultiply(wet, JOS3Defaults_js_1.default.local_bsa)) /
        ...
        if (this._ex_output && output) {
            ...
            detail_out["bf_muscle"] = math
                .subset(bf_muscle, math.index(matrix_js_1.VINDEX["muscle"]))
                .toArray();
            detail_out["bf_fat"] = math
                .subset(bf_fat, math.index(matrix_js_1.VINDEX["fat"]))
                .toArray();
            ...
            detail_out["q_bmr_muscle"] = math
                .subset(q_bmr_local[1], math.index(matrix_js_1.VINDEX["muscle"]))
                .toArray();
            detail_out["q_bmr_fat"] = math
                .subset(q_bmr_local[2], math.index(matrix_js_1.VINDEX["fat"]))
                .toArray();
            ...
            detail_out["q_thermogenesis_muscle"] = math
                .subset(q_thermogenesis_muscle, math.index(matrix_js_1.VINDEX["muscle"]))
                .toArray();
            detail_out["q_thermogenesis_fat"] = math
                .subset(q_thermogenesis_fat, math.index(matrix_js_1.VINDEX["fat"]))
                .toArray();
        ...
        if (this._ex_output === "all") {
            dict_out = Object.assign(Object.assign({}, dict_out), detail_out);
        }
        else if (Array.isArray(this._ex_output)) {
            const out_keys = object_js_1.default.keys(detail_out);
    ...
    dict_results() {
        ...
        for (let [key, value] of object_js_1.default.entries(this._history[0])) {
            let keys;
            if (value.length !== undefined) {
                if (typeof value === "string") {
                    ...
                    keys = matrix_js_1.VINDEX["sfvein"].map((i) => `${key}_${matrix_js_1.BODY_NAMES[i]}`);
                }
                else if (checkWordContain(key, "ms", "muscle")) {
                    keys = matrix_js_1.VINDEX["muscle"].map((i) => `${key}_${matrix_js_1.BODY_NAMES[i]}`);
                }
                else if (checkWordContain(key, "fat")) {
                    keys = matrix_js_1.VINDEX["fat"].map((i) => `${key}_${matrix_js_1.BODY_NAMES[i]}`);
                }
                else if (value.length === 17) {
                    keys = matrix_js_1.BODY_NAMES.map((bn) => `${key}_${bn}`);
                }
                else {
                    keys = Array.from({ length: value.length }, (_, i) => `${key}_${matrix_js_1.BODY_NAMES[i]}`);
                }
            }
            else {
                keys = [key];
        ...
        let data = this._history.map((dictout) => {
            let row = {};
            for (let [key, value] of object_js_1.default.entries(dictout)) {
        ...
        let outDict = {};
        object_js_1.default.keys(data[0]).forEach((key) => {
    ...
    _set_ex_q(tissue, value) {
        this.ex_q = math.subset(this.ex_q, math.index(matrix_js_1.INDEX[tissue]), value);
        return this.ex_q;
    }
    /**
     ...
     */
    get to() {
        const hc = (0, fixed_hc_js_1.fixed_hc)((0, conv_coef_js_1.conv_coef)(this._posture, this._va, this._ta, this.t_skin), this._va);
        const hr = (0, fixed_hr_js_1.fixed_hr)((0, rad_coef_js_1.rad_coef)(this._posture));
        return (0, operative_temp_js_1.operative_temp)(this._ta, this._tr, hc, hr);
    }
    /**
     * @param inp {number | number[] | object | math.Matrix}
     */
    ...
    get r_t() {
        const hc = (0, fixed_hc_js_1.fixed_hc)((0, conv_coef_js_1.conv_coef)(this._posture, this._va, this._ta, this.t_skin), this._va);
        const hr = (0, fixed_hr_js_1.fixed_hr)((0, rad_coef_js_1.rad_coef)(this._posture));
        return (0, dry_r_js_1.dry_r)(hc, hr, this._clo);
    }
    /**
    ...
    get r_et() {
        const hc = (0, fixed_hc_js_1.fixed_hc)((0, conv_coef_js_1.conv_coef)(this._posture, this._va, this._ta, this.t_skin), this._va);
        return (0, wet_r_js_1.wet_r)(hc, this._clo, this._iclo);
    }
    /**
    ...
    get w() {
        ...
        const { wet } = (0, evaporation_js_1.evaporation)(err_cr, err_sk, this.t_skin, this._ta, this._rh, this.r_et, this._bsa_rate, this._age);
        return wet;
    }
    /**
    ...
    get w_mean() {
        const wet = this.w;
        const bsa_sum = math.sum(JOS3Defaults_js_1.default.local_bsa);
        return math.sum(math.dotMultiply(wet, JOS3Defaults_js_1.default.local_bsa)) / bsa_sum;
    }
    /**
     ...
     */
    get t_skin_mean() {
        return (math.sum(math.dotMultiply(math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["skin"])), JOS3Defaults_js_1.default.local_bsa)) / math.sum(JOS3Defaults_js_1.default.local_bsa));
    }
    /**
     ...
     */
    get t_skin() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["skin"]));
    }
    /**
     * @param inp {number | number[] | object | math.Matrix}
     */
    set t_skin(inp) {
        this._bodytemp = math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["skin"]), _to17array(inp));
    }
    /**
     * Skin temperatures by the local body segments [°C].
     *
     ...
     */
    get t_core() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["core"]));
    }
    /**
     ...
     */
    get t_artery() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["artery"]));
    }
    /**
     ...
     */
    get t_vein() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["vein"]));
    }
    /**
    ...
    get t_superficial_vein() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["sfvein"]));
    }
    /**
     ...
     */
    get t_muscle() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["muscle"]));
    }
    /**
     ...
     */
    get t_fat() {
        return math.subset(this._bodytemp, math.index(matrix_js_1.INDEX["fat"]));
    }
    /**
     * JOS3 body names
     *
     ...
     */
    get bmr() {
        const tcr = (0, basal_met_js_1.basal_met)(this._height, this._weight, this._age, this._sex, this._bmr_equation);
