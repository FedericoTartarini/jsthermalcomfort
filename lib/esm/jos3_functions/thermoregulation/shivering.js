 ...
 */
export function shivering(err_cr, err_sk, t_core, t_skin, height = JOS3Defaults.height, weight = JOS3Defaults.weight, bsa_equation = JOS3Defaults.bsa_equation, age = JOS3Defaults.age, sex = JOS3Defaults.sex, dtime = 60, options = {}) {
    ...
    if (options["shivering_threshold"]) {
        ...
        let tskm = math.sum(math.dotMultiply(t_skin, JOS3Defaults.local_bsa)) /
