 ...
 */
export function pmv(tdb: number, tr: number, vr: number, rh: number, met: number, clo: number, wme?: number, standard?: "ISO" | "ASHRAE", kwargs?: PmvKwargs): number;
/**
 * Returns Predicted Mean Vote ( {@link https://en.wikipedia.org/wiki/Thermal_comfort#PMV/PPD_method|PMV} ) calculated
 * in accordance with main thermal comfort Standards.
 *
 ...
 */
export function pmv_array(tdb: number[], tr: number[], vr: number[], rh: number[], met: number[], clo: number[], wme: number[], standard?: "ISO" | "ASHRAE", kwargs?: PmvKwargs): number[];
export type PmvKwargs = {
    /**
