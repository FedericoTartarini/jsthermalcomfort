...
describe("two_nodes", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      expected: { set: 24.662341402637953 },
    },
    {
      tdb: 25,
      tr: 25,
...
describe("two_nodes_array", () => {
  it.each([
    ...
    },
    {
      ...
      p_atmospheric: [101325, 101325],
      body_position: ["standing", "standing"],
      max_skin_blood_flow: undefined,
      kwargs: undefined,
      expected: {
        e_skin: [16.2, 16.2],
    ...
    },
    {
      ...
      body_surface_area: undefined,
      p_atmospheric: undefined,
      body_position: ["standing", "standing", "standing", "standing"],
      max_skin_blood_flow: undefined,
      kwargs: undefined,
      expected: {
    ...
    },
    {
      ...
      body_surface_area: undefined,
      p_atmospheric: undefined,
      body_position: ["standing", "sitting", "standing", "sitting", "standing"],
      max_skin_blood_flow: undefined,
      kwargs: undefined,
      expected: {
        e_skin: [64.6, 49.5, 17.7, 39.4, 53.6],
        e_rsw: [59.7, 38.1, 8.5, 25, 50.1],
        e_max: [140.6, 228.6, 161.1, 264.4, 107.7],
        q_sensible: [-7.2, 3.5, 36.4, 29.4, 19.6],
        q_skin: [57.3, 53, 54.1, 68.8, 73.2],
        q_res: [4.9, 4.3, 3.8, 6.9, 2.8],
        t_core: [37, 36.9, 36.8, 36.9, 37],
        t_skin: [35.6, 35.1, 34, 34.3, 35.1],
        m_bl: [31.5, 20.6, 12, 18.5, 29.4],
        m_rsw: [87.8, 56, 12.6, 36.8, 73.7],
        w: [0.5, 0.2, 0.1, 0.1, 0.5],
        w_max: [0.7, 0.6, 0.6, 0.7, 0.7],
        set: [34.4, 29.3, 24.8, 25.2, 32.8],
        et: [33.4, 32.9, 28.1, 28.3, 35.5],
        pmv_gagge: [3.4, 2.5, 0.6, 0.8, 2.1],
        pmv_set: [2.6, 1, 0.3, 0, 2.4],
        disc: [3.1, 1.4, 0.4, 0.5, 3.3],
        t_sens: [2.4, 1.5, 0.4, 0.8, 1.8],
      },
    },
    {
      tdb: [40, 40, 40, 40],
      ...
      p_atmospheric: undefined,
      body_position: undefined,
      max_skin_blood_flow: [70, 80, 90, 100],
      kwargs: undefined,
      expected: {
        e_skin: [75.1, 75.6, 76, 76.3],
        e_rsw: [73.4, 73.8, 74.2, 74.5],
        e_max: [102.7, 103.4, 103.9, 104.3],
        q_sensible: [-31.3, -31, -30.8, -30.7],
        q_skin: [43.8, 44.5, 45.1, 45.6],
        q_res: [2.6, 2.6, 2.6, 2.6],
        t_core: [37.6, 37.6, 37.6, 37.6],
        t_skin: [37.1, 37.1, 37.2, 37.2],
        m_bl: [70, 80, 90, 99.7],
        m_rsw: [107.9, 108.5, 109.1, 109.5],
        w: [0.7, 0.7, 0.7, 0.7],
        w_max: [0.7, 0.7, 0.7, 0.7],
        set: [40.8, 40.8, 40.8, 40.8],
        et: [40.9, 40.9, 40.9, 40.9],
        pmv_gagge: [4.9, 4.8, 4.8, 4.8],
        pmv_set: [4.2, 4.2, 4.2, 4.2],
        disc: [5.2, 5.2, 5.2, 5.2],
        t_sens: [3.4, 3.4, 3.4, 3.4],
      },
    },
    {
      tdb: [25, 35, 40],
      ...
      p_atmospheric: undefined,
      body_position: undefined,
      max_skin_blood_flow: [90, 90, 90],
      kwargs: { calculate_ce: true },
      expected: {
        set: [24.662341402637953, 30.316140625628694, 37.411665924404794],
      },
    },
  ])(
    "returns $expected when tdb is $tdb, tr is $tr, v is $v, rh is $rh, met is $met, clo is $clo ",
