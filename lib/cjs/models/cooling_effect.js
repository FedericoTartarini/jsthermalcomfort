...
exports.brent = exports.cooling_effect = void 0;
 ...
 */
function cooling_effect(tdb, tr, vr, rh, met, clo, wme = 0, units = "SI") {
    if (units.toLowerCase() === "ip") {
        const result = (0, utilities_js_1.units_converter)({ tdb, tr, vr }, "IP");
        tdb = result.tdb;
        tr = result.tr;
        vr = result.vr;
    }
    ...
    const initial_set_tmp = (0, set_tmp_js_1.set_tmp)(tdb, tr, vr, rh, met, clo, wme, undefined, undefined, undefined, undefined, false, {
        round: false,
        calculate_ce: true,
    });
    function func(x) {
        return ((0, set_tmp_js_1.set_tmp)(tdb - x, tr - x, still_air_threshold, rh, met, clo, wme, undefined, undefined, undefined, undefined, false, {
            round: false,
            calculate_ce: true,
        }) - initial_set_tmp);
    }
    ...
    return (0, utilities_js_1.round)(ce, 2);
}
exports.cooling_effect = cooling_effect;
