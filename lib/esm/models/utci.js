 ...
 */
export function utci(tdb, tr, v, rh, units = "SI", return_stress_category = false, limit_inputs = true) {
    let kwargs;
    let ret;
 ...
 * // will print {
   //     utci: [25.2, 24.6],
    ...
    //  }
 */
export function utci_array(tdb, tr, v, rh, units = "SI", return_stress_category = false, limit_inputs = true) {
    let kwargs;
    let ret;
    if (units.toLowerCase() == "ip") {
        kwargs = {
