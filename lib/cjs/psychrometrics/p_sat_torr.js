...
exports.p_sat_torr_array = exports.p_sat_torr = void 0;
/**
 ...
 */
function p_sat_torr(tdb) {
    return Math.exp(18.6686 - 4030.183 / (tdb + 235.0));
}
exports.p_sat_torr = p_sat_torr;
/**
 * Estimates the saturation vapour pressure in [torr].
 *
 *
 ...
 * @returns {number[]} saturation vapour pressure [torr]
 */
function p_sat_torr_array(tdb) {
    return tdb.map(p_sat_torr);
}
exports.p_sat_torr_array = p_sat_torr_array;
