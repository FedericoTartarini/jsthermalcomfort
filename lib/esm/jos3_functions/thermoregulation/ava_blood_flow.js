 ...
 */
export function ava_blood_flow(err_cr, err_sk, height = JOS3Defaults.height, weight = JOS3Defaults.weight, bsa_equation = JOS3Defaults.bsa_equation, age = JOS3Defaults.age, ci = JOS3Defaults.cardiac_index) {
    ...
    let err_msk = math.sum(math.dotMultiply(err_sk, JOS3Defaults.local_bsa)) /
