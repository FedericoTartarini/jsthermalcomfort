 ...
 */
function solar_gain(sol_altitude, sharp, sol_radiation_dir, sol_transmittance, f_svv, f_bes, asw = 0.7, posture = "sitting", floor_reflectance = 0.6) {
    ...
    if (posture === "supine") {
        [sharp, sol_altitude] = (0, utilities_js_1.transpose_sharp_altitude)(sharp, sol_altitude);
    }
