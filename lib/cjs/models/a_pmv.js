...
exports.a_pmv_array = exports.a_pmv = void 0;
 ...
 */
function a_pmv(tdb, tr, vr, rh, met, clo, a_coefficient, wme = 0, kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
    };
    kwargs = Object.assign(default_kwargs, kwargs);
    const _pmv = (0, pmv_js_1.pmv)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    return (0, utilities_js_1.round)(_pmv / (1 + a_coefficient * _pmv), 2);
}
exports.a_pmv = a_pmv;
/**
 * Returns Adaptive Predicted Mean Vote (aPMV) {@link #ref_25|[25]}.
 ...
 */
function a_pmv_array(tdb, tr, vr, rh, met, clo, a_coefficient, wme, kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
    };
    kwargs = Object.assign(default_kwargs, kwargs);
    const _pmv = (0, pmv_js_1.pmv_array)(tdb, tr, vr, rh, met, clo, wme, "ISO", kwargs);
    return _pmv.map((_pmvValue, i) => (0, utilities_js_1.round)(_pmvValue / (1 + a_coefficient[i] * _pmvValue), 2));
}
exports.a_pmv_array = a_pmv_array;
