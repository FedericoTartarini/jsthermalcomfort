import { check_standard_compliance_array, round, units_converter, units_converter_array, valid_range, } from "../utilities/utilities.js";
 ...
 */
export function pmv_ppd(tdb, tr, vr, rh, met, clo, wme = 0, standard = "ISO", kwargs = {}) {
    ...
    const { tdb: tdb_valid, tr: tr_valid, v: v_valid, met: met_valid, clo: clo_valid, } = check_standard_compliance_array(standard, {
        tdb: [tdb],
        tr: [tr],
        v: [vr],
        met: [met],
    ...
    const compliance = standard === "ASHRAE" ? (isNaN(pmv) ? NaN : pmv > -0.5 && pmv < 0.5) : undefined;
 ...
 */
export function pmv_ppd_array(tdb, tr, vr, rh, met, clo, wme, standard = "ISO", kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
        airspeed_control: true,
    ...
    const compliance_array = standard === "ASHRAE"
    ...
    if (compliance_array !== undefined)
        result.compliance = compliance_array;
    return result;
}
/**
 * @param {number} tdb
