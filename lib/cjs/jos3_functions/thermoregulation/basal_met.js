 ...
 */
function basal_met(height = JOS3Defaults_js_1.default.height, weight = JOS3Defaults_js_1.default.weight, age = JOS3Defaults_js_1.default.age, sex = JOS3Defaults_js_1.default.sex, bmr_equation = JOS3Defaults_js_1.default.bmr_equation) {
    ...
    if (!valid_equations.includes(bmr_equation)) {
        throw new Error(`Invalid BMR equation. Must be one of ${valid_equations.join(", ")}`);
    }
    let bmr;
    switch (bmr_equation) {
