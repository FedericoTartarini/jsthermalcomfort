...
export function fixed_hc(hc, v) {
    ...
    let mean_hc = math.sum(math.dotMultiply(hc, JOS3Defaults.local_bsa)) / local_bsa_sum;
    let mean_va = math.sum(math.dotMultiply(v, JOS3Defaults.local_bsa)) / local_bsa_sum;
