...
/**
 * Representative clothing insulation Icl as a function of outdoor air
 * temperature at 06:00 a.m [1].
 * 
 * Note: The ASHRAE 55 2020 states that it is acceptable to determine the
 * clothing insulation Icl using this equation in mechanically conditioned
 * buildings [2].
 * 
 * [1] Schiavon, S., & Lee, K. H. (2013). Dynamic predictive clothing insulation
 * models based on outdoor air and indoor operative temperatures. Building and
 * Environment, 59, 250–260. doi.org/10.1016/j.buildenv.2012.08.024
 * 
 * [2] ANSI, & ASHRAE. (2020). Thermal Environmental Conditions for Human
 * Occupancy. Atlanta.
 * 
 * @public
 * 
