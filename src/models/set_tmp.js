...
import { two_nodes, two_nodes_array } from "../models/two_nodes.js";
...
// console.log(check_standard_compliance("ashrae", {tdb:25, tr:25,v:0.1, met:1.2, clo:0.5}))
console.log(
  set_tmp(77, 77, 0.328, 50, 1.2, 0.5, 0, 1.8258, 101325, "sitting", "SI"),
);
