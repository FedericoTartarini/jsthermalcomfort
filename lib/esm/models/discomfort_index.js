...
exports.discomfort_index_array = exports.discomfort_index = void 0;
 ...
 */
function discomfort_index(tdb, rh) {
    const di = calculate_di(tdb, rh);
    const condition = check_categories(di);
    return {
        di: (0, utilities_js_1.round)(di, 1),
        discomfort_condition: condition,
    };
}
exports.discomfort_index = discomfort_index;
/**
 ...
 */
function discomfort_index_array(tdb, rh) {
    const di = tdb.map((temperature, index) => calculate_di(temperature, rh[index]));
    const discomfortCondition = di.map((value) => check_categories(value));
    return {
        di: di.map((value) => (0, utilities_js_1.round)(value, 1)),
        discomfort_condition: discomfortCondition,
    };
}
exports.discomfort_index_array = discomfort_index_array;
/**
 *
