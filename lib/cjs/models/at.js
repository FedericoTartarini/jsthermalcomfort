...
exports.at = void 0;
const psy_ta_rh_js_1 = require("../psychrometrics/psy_ta_rh.js");
 ...
 */
function at(tdb, rh, v, q, kwargs = { round: true }) {
    // dividing it by 100 since the at eq. requires p_vap to be in hPa
    const p_vap = (0, psy_ta_rh_js_1.psy_ta_rh)(tdb, rh).p_vap / 100;
    let t_at;
    if (q !== undefined) {
    ...
    if (kwargs.round) {
        t_at = (0, utilities_js_1.round)(t_at, 1);
    }
    return { at: t_at };
}
exports.at = at;
