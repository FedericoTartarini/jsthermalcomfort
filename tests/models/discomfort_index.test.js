    ...
    it.each([
        {
          ...
          expected: {
                di: [22.7, 26.1, 29.1], 
                discomfort_condition: ['Less than 50% feels discomfort', 'More than 50% feels discomfort', 'Everyone feels severe stress']
            },
        },
        {
            tdb: [34.5, 38, 15.9],
            ...
            expected: {
                  di: [27.4, 33.5, 15.5], 
                  discomfort_condition: ['Most of the population feels discomfort', 'State of medical emergency', 'No discomfort']
              },
        },
    ])
(
