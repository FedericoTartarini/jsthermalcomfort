 ...
 *
 */
export function two_nodes(tdb, tr, v, rh, met, clo, wme = 0, body_surface_area = 1.8258, p_atmospheric = 101325, body_position = "standing", max_skin_blood_flow = 80, kwargs = {}) {
 ...
 *
 */
export function two_nodes_array(tdbArray, trArray, vArray, rhArray, metArray, cloArray, wmeArray, bodySurfaceArray, pAtmArray, bodyPositionArray, maxSkinBloodFlowArray, kwargs = {}) {
    const defaults_kwargs = {
        calculate_ce: false,
        round: true,
        max_sweating: 500,
