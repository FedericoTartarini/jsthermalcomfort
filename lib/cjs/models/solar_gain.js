...
exports.find_span = exports.solar_gain = void 0;
 ...
 */
function solar_gain(sol_altitude, sharp, sol_radiation_dir, sol_transmittance, f_svv, f_bes, asw = 0.7, posture = "seated", floor_reflectance = 0.6) {
    ...
    if (posture === "supine") {
        [sharp, sol_altitude] = (0, utilities_js_2.transpose_sharp_altitude)(sharp, sol_altitude);
    }
    ...
    return { erf: (0, utilities_js_1.round)(erf, 1), delta_mrt: (0, utilities_js_1.round)(d_mrt, 1) };
}
exports.solar_gain = solar_gain;
/**
 *
 * @param {number[]} arr
 * @param {number} x
