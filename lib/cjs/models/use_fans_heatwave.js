...
exports.use_fans_heatwaves = void 0;
 ...
 *
 */
function use_fans_heatwaves(tdb, tr, v, rh, met, clo, wme = 0, body_surface_area, p_atm, body_position = "standing", units = "SI", max_skin_blood_flow = 80, kwargs = {}) {
    ...
    let output = (0, two_nodes_js_1.two_nodes)(tdb, tr, v, rh, met, clo, wme, body_surface_area, p_atm, body_position, max_skin_blood_flow, { round: false, max_sweating: joint_kwargs.max_sweating });
    ...
    if (joint_kwargs.limit_inputs) {
        const { tdb: tdb_valid, tr: tr_valid, v: v_valid, met: met_valid, clo: clo_valid, } = (0, utilities_js_1.check_standard_compliance_array)("FAN_HEATWAVES", {
            tdb: [tdb],
            tr: [tr],
            v: [v],
            met: [met],
    ...
    if (joint_kwargs.round) {
        return {
            e_skin: (0, utilities_js_1.round)(joint_output.eSkin, 1),
            e_rsw: (0, utilities_js_1.round)(joint_output.eRsw, 1),
            e_max: (0, utilities_js_1.round)(joint_output.eMax, 1),
            q_sensible: (0, utilities_js_1.round)(joint_output.qSensible, 1),
            q_skin: (0, utilities_js_1.round)(joint_output.qSkin, 1),
            q_res: (0, utilities_js_1.round)(joint_output.qRes, 1),
            t_core: (0, utilities_js_1.round)(joint_output.tCore, 1),
            t_skin: (0, utilities_js_1.round)(joint_output.tSkin, 1),
            m_bl: (0, utilities_js_1.round)(joint_output.mBl, 1),
            m_rsw: (0, utilities_js_1.round)(joint_output.mRsw, 1),
            w: (0, utilities_js_1.round)(joint_output.w, 1),
            w_max: (0, utilities_js_1.round)(joint_output.wMax, 1),
...
exports.use_fans_heatwaves = use_fans_heatwaves;
/**
...
function cal_heatwave(two_nodes_result, joint_kwargs, max_skin_blood_flow) {
    let heat_strain_blood_flow, heat_strain_w, heat_strain_sweating, heat_strain = false;
