import { units_converter, check_standard_compliance_array, round, } from "../utilities/utilities.js";
 ...
 *
 */
export function use_fans_heatwaves(tdb, tr, v, rh, met, clo, wme = 0, body_surface_area, p_atm, body_position = "standing", units = "SI", max_skin_blood_flow = 80, kwargs = {}) {
    ...
    let output = two_nodes(tdb, tr, v, rh, met, clo, wme, body_surface_area, p_atm, body_position, max_skin_blood_flow, { round: false, max_sweating: joint_kwargs.max_sweating });
    ...
    if (joint_kwargs.limit_inputs) {
        const { tdb: tdb_valid, tr: tr_valid, v: v_valid, met: met_valid, clo: clo_valid, } = check_standard_compliance_array("FAN_HEATWAVES", {
            tdb: [tdb],
            tr: [tr],
            v: [v],
            met: [met],
