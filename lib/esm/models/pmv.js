 ...
 */
export function pmv(tdb, tr, vr, rh, met, clo, wme = 0, standard = "ISO", kwargs = {}) {
    ...
    const pmv_ppdValue = pmv_ppd(tdb, tr, vr, rh, met, clo, wme, standard, kwargs);
 ...
 */
export function pmv_array(tdb, tr, vr, rh, met, clo, wme, standard = "ISO", kwargs = {}) {
    const default_kwargs = {
        units: "SI",
        limit_inputs: true,
        airspeed_control: true,
    ...
    kwargs = Object.assign(default_kwargs, kwargs);
    const pmv_ppd_arrayValue = pmv_ppd_array(tdb, tr, vr, rh, met, clo, wme, standard, kwargs);
